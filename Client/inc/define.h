...
typedef enum{
    ...
    C_DSC_STEP_MOTOR_PID_ENABLE,
    C_DSC_STEP_MOTOR_PID_DISABLE,
    

    C_DSC_SENSOR_TOP_ENABLE ,
    C_DSC_SENSOR_BOTTOM_ENABLE ,
    C_DSC_SENSOR_TOP_READ_STATUS ,
    C_DSC_SENSOR_BOTTOM_READ_STATUS ,

    C_DSC_ENCODER_HARDWARE_ENABLE ,
    C_DSC_ENCODER_HARDWARE_DISABLE ,
